    ...
    public class MainActivity : Activity,ILocationListener
    {
        ...
        private class GetWeather : AsyncTask<String, Java.Lang.Void, String>
        {
            ...
            protected override void OnPostExecute(string result)
            {
                ...
                if(result.Contains("Error: Impossible de trouver cette ville"))
                {
                    pd.Dismiss();
                    return;
                }
                ...
                activity.txtLastUpdate.Text = $"Dernière modification : {DateTime.Now.ToString("dd MMMM yyyy HH:mm")}";
                activity.txtDescription.Text = $"{openWeatherMap.weather[0].description}";
                activity.txtHumidity.Text = $"Humidité : {openWeatherMap.main.humidity} %";
